...
// Cross Module References
	TOONTANKS_API UClass* Z_Construct_UClass_APlayerControllerBase_NoRegister();
	TOONTANKS_API UClass* Z_Construct_UClass_APlayerControllerBase();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APlayerControllerBase_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "Controllers/PlayerControllerBase.h" },
		{ "ModuleRelativePath", "Controllers/PlayerControllerBase.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(APlayerControllerBase, 3140085680);
	template<> TOONTANKS_API UClass* StaticClass<APlayerControllerBase>()
	{
		return APlayerControllerBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_APlayerControllerBase(Z_Construct_UClass_APlayerControllerBase, &APlayerControllerBase::StaticClass, TEXT("/Script/ToonTanks"), TEXT("APlayerControllerBase"), false, nullptr, nullptr, nullptr);
